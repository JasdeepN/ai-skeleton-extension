...
tools: ['sequential-thinking/*', 'fetch/*', 'filesystem/create_directory', 'filesystem/directory_tree', 'filesystem/get_file_info', 'filesystem/list_allowed_directories', 'filesystem/list_directory', 'filesystem/move_file', 'filesystem/read_file', 'filesystem/read_multiple_files', 'filesystem/search_files', 'git/git_diff', 'git/git_diff_staged', 'git/git_diff_unstaged', 'git/git_log', 'git/git_show', 'git/git_status', 'upstash/context7/*', 'aiSkeleton_appendToEntry', 'aiSkeleton_editEntry', 'aiSkeleton_logDecision', 'aiSkeleton_markDeprecated', 'aiSkeleton_saveExecution', 'aiSkeleton_savePlan', 'aiSkeleton_saveResearch', 'aiSkeleton_showMemory', 'aiSkeleton_updateContext', 'aiSkeleton_updatePatterns', 'aiSkeleton_updateProgress', 'aiSkeleton_updateProjectBrief', 'extensions', 'todos', 'runSubagent', 'vscodeAPI', 'problems', 'testFailure', 'githubRepo', 'jasdeepn.ai-skeleton-extension/showMemory', 'jasdeepn.ai-skeleton-extension/logDecision', 'jasdeepn.ai-skeleton-extension/saveResearch', 'jasdeepn.ai-skeleton-extension/savePlan', 'jasdeepn.ai-skeleton-extension/saveExecution', 'jasdeepn.ai-skeleton-extension/updateContext', 'jasdeepn.ai-skeleton-extension/updateProgress', 'jasdeepn.ai-skeleton-extension/updatePatterns', 'jasdeepn.ai-skeleton-extension/updateBrief', 'jasdeepn.ai-skeleton-extension/markDeprecated', 'ms-vscode.vscode-websearchforcopilot/websearch']
